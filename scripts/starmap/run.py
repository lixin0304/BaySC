"""
STARmap: Compute all metrics (including spARI) with locked parameters.
Save clustering results (GT + prediction) in standard format.

Params: K=7: lam=70, th=1000, t0=10, gamma=10, ARI=0.5291
"""
...
def main():
    ...
    data_dir = os.path.join(PROJECT_ROOT, 'data', 'processed', 'starmap')
    output_dir = os.path.join(PROJECT_ROOT, 'outputs', 'STARmap')
