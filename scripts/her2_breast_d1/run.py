"""
HER2 Breast D1: Compute all metrics (including spARI) with locked parameters.
Save clustering results (GT + prediction) and append metrics to CSV.

Params: K=3: lam=25, th=400, t0=10, gamma=3, ARI=0.2599
"""
...
def main():
    ...
    data_dir = os.path.join(PROJECT_ROOT, 'data', 'processed', 'her2_breast_d1')
    output_dir = os.path.join(PROJECT_ROOT, 'outputs', 'HER2_Breast_D1')
