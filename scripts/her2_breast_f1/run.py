"""
HER2 Breast F1: Compute all metrics (including spARI) with locked parameters.
Save clustering results (GT + prediction) and append metrics to CSV.

Params: K=3: lam=50, th=450, t0=10, gamma=10, ARI=0.1856
"""
...
def main():
    ...
    data_dir = os.path.join(PROJECT_ROOT, 'data', 'processed', 'her2_breast_f1')
    output_dir = os.path.join(PROJECT_ROOT, 'outputs', 'HER2_Breast_F1')
