"""
HER2 Breast E1: Compute all metrics (including spARI) with locked parameters.
Save clustering results (GT + prediction) and append metrics to CSV.

Params: K=3: lam=70, th=400, t0=3, gamma=10, ARI=0.2682
"""
...
def main():
    ...
    data_dir = os.path.join(PROJECT_ROOT, 'data', 'processed', 'her2_breast_e1')
    output_dir = os.path.join(PROJECT_ROOT, 'outputs', 'HER2_Breast_E1')
