"""
HER2 Breast H1: Compute all metrics (including spARI) with locked parameters.
Save clustering results (GT + prediction) and append metrics to CSV.

Params: K=6: lam=450, th=15, t0=8, gamma=1, ARI=0.4132
"""
...
def main():
    ...
    data_dir = os.path.join(PROJECT_ROOT, 'data', 'processed', 'her2_breast_h1')
    output_dir = os.path.join(PROJECT_ROOT, 'outputs', 'HER2_Breast_H1')
